...
jQuery(function ($, undefined) {
    ...
    $.widget("soaf.securityLabelRest", {
        ...
        _create: function () {
            console.log("SOAF_REST_CREATE()");
            this._super();
            _Settings = this.options;
            $.securityLabelRest = this.element.data("soafSecurityLabelRest");
        },
        _destroy: function () {
            console.log("SOAF_REST_DESTROY()");
            return this._super();
        },
        ...
        lastProperty: 'The END of Widget soaf.securityLabelRest' // Do Not move, for convenience only
    });
