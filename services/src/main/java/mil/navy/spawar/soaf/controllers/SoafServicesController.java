...
import mil.navy.spawar.soaf.data.DataAccessException;
import mil.navy.spawar.soaf.data.IMongoDataAccessManager;
import mil.navy.spawar.soaf.data.RecordNotFoundException;
import mil.navy.spawar.soaf.ldap.ISoafLdapService;
import mil.navy.spawar.soaf.security.ISoafUserDetails;
import mil.navy.spawar.soaf.security.SecurityManager;
...
public class SoafServicesController {

    private static final Logger log = (Logger) LoggerFactory.getLogger(SoafServicesController.class);
    ...
    public
    @ResponseBody
    String ping(HttpServletResponse response) throws IOException {
    ...
    public
    @ResponseBody
    String userDetails(HttpServletResponse response) {

        response.setStatus(HttpServletResponse.SC_OK);

        try {
            SoafUserDetailsImpl userDetails = (SoafUserDetailsImpl) SecurityManager.getUserDetails();
    ...
    public
    @ResponseBody
    String retrieveUsers(@RequestParam(value = "user", required = false) List<String> users, HttpServletResponse response) {
    ...
    public
    @ResponseBody
    String findAll(@PathVariable("collection") final String collection, HttpServletResponse response) throws Exception {
        try {
            // get record from db
    ...
    public
    @ResponseBody
    String findById(@PathVariable("collection") final String collection, @PathVariable("id") final String id, HttpServletResponse response) throws Exception {
        try {
    ...
    public
    @ResponseBody
    String fullTextQuery(@PathVariable("collection") final String collection, @RequestParam(value = "q", defaultValue = "*") final String terms, HttpServletResponse response) throws Exception {
    ...
    */
    ...
    public
    @ResponseBody
    String create(@PathVariable("collection") final String collection, @RequestBody String json, HttpServletResponse response) throws Exception {
        try {
    ...
    public
    @ResponseBody
    void delete(@PathVariable("collection") final String collection,
    ...
    public
    @ResponseBody
    void update(@PathVariable("collection") final String collection, @PathVariable("id") final String id, @RequestBody String json, HttpServletResponse response) throws Exception {
        try {
            // get json object from request
    ...
    public void findBinaryById(@PathVariable("id") final String id, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            if (records != null && records.size() == 1) {
                ...
                response.setHeader("Content-Disposition", "attachment;filename=" + record.get("fileName"));
    ...
    public
    @ResponseBody
    void updateBinary(@RequestBody String json, HttpServletResponse response) throws Exception {
    ...
    public
    @ResponseBody
    String handleException(Exception ex, HttpServletResponse resp) {
