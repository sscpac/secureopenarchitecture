package mil.navy.spawar.soaf.controllers;
...
import mil.navy.spawar.soaf.data.IMongoDataAccessManager;
import mil.navy.spawar.soaf.security.ISoafUserDetails;
import mil.navy.spawar.soaf.security.SoafUserDetailsImpl;
import mil.navy.spawar.soaf.testutils.EmbeddedMongoServer;
...
@ContextConfiguration(locations={"classpath:/config/SoafServicesControllerIT/config.xml"})
public class SoafServicesControllerIT {
	...
	@InjectMocks
	private SoafServicesController controller;
	...
	public void setup() throws Exception {
		...
		assertTrue(authToken.getUserDetails() instanceof ISoafUserDetails);
	...
	public void testUserDetails() throws Exception {
		...
		assertTrue(authToken.getUserDetails() instanceof SoafUserDetailsImpl);
		String expectedResponse =  ((SoafUserDetailsImpl)authToken.getUserDetails()).toJson();
    ...
    @Test
    @UsingDataSet(locations={"/data/SoafServicesControllerIT/readCollection/data-load.json"},loadStrategy=LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location="/data/SoafServicesControllerIT/readCollection/data-expected.json")
    ...
    @Test
    @UsingDataSet(locations={"/data/SoafServicesControllerIT/fullTextQuery/data-load.json"},loadStrategy=LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location="/data/SoafServicesControllerIT/fullTextQuery/data-expected.json")
    ...
    @Test
    @UsingDataSet(locations={"/data/SoafServicesControllerIT/mongoQuery/data-load.json"},loadStrategy=LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location="/data/SoafServicesControllerIT/mongoQuery/data-expected.json")
    ...
    @Test
    @UsingDataSet(locations={"/data/SoafServicesControllerIT/createRecord/data-load.json"},loadStrategy=LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location="/data/SoafServicesControllerIT/createRecord/data-expected.json")
    ...
    @Test
    @UsingDataSet(locations={"/data/SoafServicesControllerIT/createRecord/data-load.json"},loadStrategy=LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location="/data/SoafServicesControllerIT/createRecord/data-expected-error.json")
    ...
    @Test
    @UsingDataSet(locations={"/data/SoafServicesControllerIT/deleteRecord/data-load.json"},loadStrategy=LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location="/data/SoafServicesControllerIT/deleteRecord/data-expected.json")
    ...
    @Test
    @UsingDataSet(locations={"/data/SoafServicesControllerIT/deleteRecord/data-load.json"},loadStrategy=LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location="/data/SoafServicesControllerIT/deleteRecord/data-expected-error.json")
	...
	@Test
    @UsingDataSet(locations={"/data/SoafServicesControllerIT/updateRecord/data-load.json"},loadStrategy=LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location="/data/SoafServicesControllerIT/updateRecord/data-expected.json")
	...
	@Test
    @UsingDataSet(locations={"/data/SoafServicesControllerIT/updateRecord/data-load.json"},loadStrategy=LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location="/data/SoafServicesControllerIT/updateRecord/data-expected-error.json")
	...
	@Test
    @UsingDataSet(locations={"/data/SoafServicesControllerIT/binaryRecord/data-load.json"},loadStrategy=LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location="/data/SoafServicesControllerIT/binaryRecord/data-expected.json")
	...
	@Test
    @UsingDataSet(locations={"/data/SoafServicesControllerIT/binaryRecord/data-load.json"},loadStrategy=LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location="/data/SoafServicesControllerIT/binaryRecord/data-expected-error.json")
	...
	@Test
    @UsingDataSet(locations={"/data/SoafServicesControllerIT/binaryRecord/data-load.json"},loadStrategy=LoadStrategyEnum.CLEAN_INSERT)
    @ShouldMatchDataSet(location="/data/SoafServicesControllerIT/binaryRecord/data-load.json")
