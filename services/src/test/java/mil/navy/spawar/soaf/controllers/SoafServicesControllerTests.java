...
public class SoafServicesControllerTests {
	...
	public void testUserDetails() throws Exception {
		...
		ApplicationContext ctx = new ClassPathXmlApplicationContext("classpath:/config/SoafServicesControllerTests/userDetails-config.xml");
		assertNotNull(ctx);
