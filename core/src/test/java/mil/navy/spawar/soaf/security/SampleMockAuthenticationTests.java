...
public class SampleMockAuthenticationTests {
	...
	public void testSampleTest()  {
		...
		assertEquals("cn=soafUser,ou=Users,dc=spawar,dc=navy,dc=mil",  userDetails.getDistinguishedName());
		assertEquals("soafUser",  userDetails.getUsername());
