...
public class SwifUserDetailsImpl implements ISwifUserDetails {
	...
	public SwifUserDetailsImpl(String username, Collection<? extends GrantedAuthority> roles, String dn) {
		this.roles = roles;
