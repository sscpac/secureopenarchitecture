...
public class SAPMongoRecordFilterTests {
	...
	private SAPMongoRecordFilter filter;
	...
	public void setUp() {
		...
		assertTrue(filter instanceof SAPMongoRecordFilter);
		...
		// load input data
		inputData = loadJson("/sap-module-test-data.json");
	...
	public void testCanSeeEveryThing()  {
		...
		// give user all access
		userAttrs.get(EXPECTED_USERDETAIL_ATTR).clear();
		userAttrs.get(EXPECTED_USERDETAIL_ATTR).add("SAP-1");
		userAttrs.get(EXPECTED_USERDETAIL_ATTR).add("SAP-2");
		userAttrs.get(EXPECTED_USERDETAIL_ATTR).add("SAP-3");
		userAttrs.get(EXPECTED_USERDETAIL_ATTR).add("SAP-4");
		userAttrs.get(EXPECTED_USERDETAIL_ATTR).add("SAP-5");
	...
	@Test
	@DirtiesContext
	public void testUserHasNoSapMarking()  {
