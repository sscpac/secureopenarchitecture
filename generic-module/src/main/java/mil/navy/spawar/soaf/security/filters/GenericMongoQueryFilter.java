...
public class GenericMongoQueryFilter implements IMongoQueryFilter {

   private static final Logger log = (Logger) LoggerFactory.getLogger(GenericMongoQueryFilter.class);
	...
	@Override
	public BasicDBObject filter(ISoafUserDetails userDetails) {
