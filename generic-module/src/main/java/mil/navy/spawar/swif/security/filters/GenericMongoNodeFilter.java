...
public class GenericMongoNodeFilter implements IMongoNodeFilter {

    private static final Logger log = (Logger) LoggerFactory.getLogger(GenericMongoNodeFilter.class);
