...
@ContextConfiguration(locations={"classpath:generic-module-test-config.xml"})
public class GenericMongoRecordFilterTests {
	...
	private GenericMongoRecordFilter filter;
	...
	public void setUp() {
		...
		assertTrue(filter instanceof GenericMongoRecordFilter);
		...
		// load input data
		inputData = loadJson("/generic-module-test-data.json");
