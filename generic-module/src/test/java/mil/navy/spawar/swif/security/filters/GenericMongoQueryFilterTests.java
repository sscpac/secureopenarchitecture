...
public class GenericMongoQueryFilterTests {
	...
	GenericMongoQueryFilter filter;
	
	@Autowired(required=true)
	SwifUserDetailsImpl userDetails;
	...
	public void setUp() {
		...
		assertTrue(filter instanceof GenericMongoQueryFilter);
